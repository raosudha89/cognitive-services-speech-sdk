...
ACCOUNT_NAME = ""
ACCOUNT_KEY = ""
URI_PREFIX = "https://easip.blob.core.windows.net/youcook2-videos-audio"
...
def main(args):
    ...
    outfile = os.path.join(args.output_file_dir, file_name + ".json") 
    if not os.path.exists(outfile):
        transcribe(outfile, file_name)
